...
<body>
    ...
    <div class="clearfix"></div>
        ...
        <header class="panel_header">
                <h2 class="title pull-left">Matricular <?php echo $id_cmei ?></h2>
         ...
         <?php
            ...
            tbcmei.tbcmei_nome
             ...
             ?> 
              <tr> <td> <a href='./#/matricular' class='btn btn-primary'>Nova busca</a> </td></tr>
              <tr> <td> <a id="gerarExcel" href="mat_gerarExcel.php?motivo=<?php echo $motivo;?>&turma=<?php echo $turma;?>&id_cmei=<?php echo $id_cmei;?>"
                                ...
                                <tbody>
                                        <tr>
                                           <td align ="center"> <a href="../admin/alterafila.php?tbfila_id=<?php echo $id_fila;?>&ordem=<?php echo $ordem;?>"><?php echo $id_fila;?></a>         
                                            ...
                                            <td><?php echo $ln['tbaluno_tel'];?></td>
                                            <td><?php echo $ln['celu'];?></td>
                                            <td><?php echo $ln['celular'];?></td>
											...
											<?php
                                                ...
                                                if ($ordem == 1)
                                                {
                                                    echo "<a href='confrmatricula.php?tbfila_id=$id_fila' class='btn btn-primary'>Matricular</a>"; 
                                                    echo "<a href='remove_fila.php?tbfila_id=$id_fila&ordem=$ordem' class='btn btn-primary'>Remover</a>";     
