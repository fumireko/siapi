                            ...
                            <div class="content-body">    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-sm-9 col-xs-10">
                                        ...
                                        <?php include('conexao.php'); 
        									 ...
        									 <option value="">Selecione...</option>
      										...
      										<div  class="form-group" id="load_cidades">
                                                ...
                                                <br>
                                              <em> (Neste campo você seleciona seu Departamento no qual esta lotado)</em>
                                        ...
                                        <div class="form-group">
                                            <label for="img-anexo" class="form-label">Registre uma foto do problema (opcional)</label>
                                            <input type="upload">
                                        </div>
