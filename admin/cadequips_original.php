...
<input type="hidden" name="rec_user" size=50 value= "">
<input type="hidden" name="loc_id" size=50 value= "">
<input type="hidden" name="sec_id" size=50 value= "">

</BR> </BR> </BR> 
<center>  
      <h2> "Secretaria"</h2> 
    <h3> "local unidade"</h3>     <br /></center>
<div class="container">
                                ...
                                <div class="form-horizontal meuform">
                                    <div class="form-group row">
                                       <div class="col-md-2">     
                                            ...
                                            <input class="form-control text-uppercase" id="plaqueta" name="plaqueta"   value = "" required/>
                                        </div>
                                             <div class="col-md-2">     
