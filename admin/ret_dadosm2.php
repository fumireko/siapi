...
<?php
                                  ...
                                  <input type="hidden" name="modalidade" size=50 value= "13">  
                                   <input type="hidden" name="pc_antigo" size=50 value= "<?php echo $ret_id_equip ?>">  
                               ...
                               if (($ret_id_equip == "") || ($ret_id_equip == "0")) {
                                   ?> 
                                          ...
                                          <label> Novo Vinculo ao Computador  :  </label> 
                                           &nbsp &nbsp <input name="novo_pc"  style="background-color:#E4F4F5;" type="text" id="novo_pc" size="7" value="" title="Numero do CTI do novo Computador" />    &nbsp &nbsp
									       &nbsp &nbsp   &nbsp  <label>Saida de Video :</label> &nbsp &nbsp   &nbsp
                                                                           <select title="Selecione a opção utilizada de saida de video "  id="mon_saida" name="mon_saida" style="background-color: #E4F4F5;"  >
                                     ...
                                     <button class="botao submit" type="submit" name="submit">Executar</button>
							   ...
							   <?php
                                   ...
                                   if ($qtdM == 0) {
									...
									<?php
                                     ...
                                     &nbsp &nbsp &nbsp &nbsp   &nbsp  <button class="botao submit" type="submit" name="submit">Executar</button>
