          ...
          else
          {
				//	  $sql = "SELECT * FROM dadoste WHERE D_ID = '".$parametro."'" ;
                      ...
                      $row = mysqli_fetch_assoc($dados);
                        ...
                        $ret_nome_loc = nomedolocal($conn, $row['local_id']); // par4
                        $ret_nome_sec = nomedesecretaria($conn,cod_sec($conn,$row['local_id']));// par3
                ...
                ?>
								...
								<br /><br />
                                   ...
                                   <a href="qrimpressaodiv_termo.php?var=<?php echo $ret_id ?>" title="Ir para Local ">Termo de Responsabilidade   </a>  <br /><br />
...
{      // recebimento atraves do metodo  GET direto do listaequip
        ...
        if ($qtd == 0) {
            echo " <br><br> <h1> <center> <b> Numero de Controle da SMTI , nao Localizado  </b></center> </h1> ";
        ...
        } else 
          {
            ...
            $retorno = $id_tab;
            $tp_equip = substr($codequip, 0, 1);
            $tbequip_id = substr($codequip, 1);
            //   $ret_id=$retorno;
           // echo $tab;
            $rettemp = "";
            $localizacao = 'https://portal.colombo.pr.gov.br/siapi/admin/ver_equipti.php?tbequip_id=';
                          ...
                          if( $tab==3  )      // busca em monitores                        
                           {
                                ...
                                {  //  echo"retorno zero de nome na base   ".$nome;
                                    ...
                                    $titulo = "\n Resultado da busca do Patrimonio    \n " . $id_tab . " \n  Registro nao sEncontrado  ";
                                    echo "<center> <p style=color:red> <b>" . nl2br($titulo) . " </b>  </p></center> ";
                                    echo " <label> Controle TI : " . $parametro . "  Tabela : " . $codequip . " </label><br />";
                                ...
                                else
                                 {
                                    ...
                                    $dados = mysqli_query($conn, $sql) or die(mysqli_error());
                                    $row = mysqli_fetch_assoc($dados);
                                    $ret_idloc = $row['local_id']; //cmei  id
                                    $ret_desc = $row['mon_marca'];
                                    $ret_tam = $row['mon_tam'];
                                    $ret_tipo = "MONITOR";
                                    $ret_id = $row['id']; // id
                                    $ret_ctrl_ti = $row['ctrl_ti']; // id
                                    $ret_status = $row['status']; // 
                                    $ret_nome = $ret_tipo."  ".$ret_desc; // par1
                                    $ret_patrimonio = $row['mon_plaqueta'];// par2
                                    $ret_nome_loc = nomedolocal($conn, $row['local_id']); // par4
                                    $ret_nome_sec = nomedesecretaria($conn, cod_sec($conn, $row['local_id']));// par3
                                 //   $ret_obs = $row['obs']; // par12
                                    ...
                                    ?>                      
                                                      ...
                                                      <label> <strong> ****   Resumo da Busca  **** </strong> </label><br /><br />
								                    <label> <?php echo $ret_tipo; ?>   </label><br />                                 
								                     <label> Controle TI : <?php echo $parametro; ?>  Tabela Div. : <?php echo $codequip; ?>   </label><br />
                                                      <label> Equipamento Nome :  <?php echo $ret_nome; ?>   </label><br />
                                                    ...
                                                    <br />	
                                                      <a href="qr_ind_ti.php?id=0" title="SELECIONAR ">Voltar   </a>  
                                                      <br /><br /><br />
                                                       <a href="qrimpressao_ti.php?var=<?php echo $ret_ctrl_ti ?>" title="Ir para Local ">Impressao de QR Code   </a>  
                                                       <br /><br /><br />
                                                       <a href=" <?php echo $value ?>" title="Verificar dados completos ">Dados completos   </a>  
                                                       <br /><br /><br />

                                                       <a href="qrimpressaodiv_termo.php?var=<?php echo $ret_ctrl_ti ?>" title="Ir para Local ">Termo de Responsabilidade   </a>  <br /><br />
                                                </body>
                                  ...
                                  if ($tab == 2) // busca em diversos
                                  {
                                      ...
                                      {  //  echo"retorno zero de nome na base   ".$nome;
                                          ...
                                          ?>                      
                                                <br /><br /><br />
                                                 <label> <strong> ****   Resumo da Busca  **** </strong> </label><br /><br />
						                          <label> <?php echo $ret_tipo." <  ".$tab." > "; ?>   </label><br />                                 
								                     <label> Controle TI : <?php echo $parametro; ?>  Tabela Div. : <?php echo $codequip; ?>   </label><br />
                                                      <label> Equipamento Nome :  <?php echo $ret_nome; ?>   </label><br />
                                                      <label> Plaqueta Patrimonio :  <?php echo $ret_patrimonio; ?>     </label> <br />
                                                      <label> Local / Departamento :  </label><br />
                                                      ...
                                                      <a href="qr_ind.php?id=0" title="SELECIONAR ">Voltar   </a>  <br /><br />
                                                       ...
                                                       <a href="qrimpressao_ti.php?var=<?php echo $parametro; ?> ">Impressao de QR Code   </a>                                                     
                                                    <br /><br /><br />

                                                       <a href=" <?php echo $value ?>" title="Verificar dados completos ">Dados completos   </a>  <br /><br />

                                                       <a href="qrimpressaodiv_termo.php?var=<?php echo $parametro; ?>  ">Termo de Responsabilidade   </a>  <br /><br />
                                                </body>
                                    ...
                                    else  // busca em tbequip
                                    {
                                           
                                      
                                      
                                      
                                                $sql =  "SELECT * FROM tbequip where tbequip_id = '".$id_tab."'  ";
	                                            $result = mysqli_query($conn, $sql);
	                                            $retorno_checkInEng = mysqli_num_rows($result);
                                                ...
                                                {  //  echo"retorno zero de nome na base   ".$nome;
								                    ...
								                    <label> <?php echo $ret_tipo; ?>   </label><br />                                 
								                     <label> Controle TI : <?php echo $parametro; ?>  Tabela Div. : <?php echo $codequip; ?>   </label><br />
                                                      ...
                                                      <a href="qr_ind_ti.php?id=0" title="SELECIONAR ">Voltar   </a>  <br /><br />
