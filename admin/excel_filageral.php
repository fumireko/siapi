...
$consultaMat = mysql_query("SELECT  tbaluno.tbaluno_nmae, tbaluno_tel, celu,
celular, tbaluno.tbaluno_dtnasc,
...
$html .= '<table>';
$html .= '<tr>';
$html .= '<td><b>Cod_fila</b></td>';
$html .= '<td><b>Nome</b></td>';
$html .= '<td><b>Nome da mae</b></td>';
$html .= '</tr>';
if(mysql_num_rows($consultaMat) > 0){
    while(list($id_fila, $nm_aluno, $n_mae, $telefone, $celu,$celular, 
    $tbaluno_tel,$celu,$celular,$data, $aluno_turma,  
    $id_fila_aluno, $dtcad, $fila_motivo, $fila_id_cmei, 
    $cmei_id_cmei, $cmei_nome) = mysql_fetch_array($consultaMat)){
        $ordem++;
