...
?>
<form target="_blank" name="forms" action="anexo06-b.php" method="post" enctype="multipart/form-data">
...
<td width="816">
  ...
  <CENTER> <p class="style17"><strong>IT04 - ANEXO 6- REQUERIMENTO DE VISTORIA PRÉVIA DO ESTABELECIMENTO</p>  </CENTER>
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td bgcolor="#F9F9F9">
          <span class="style9"><span class="style14"><span class="style15A">venho através deste, requerer VISTORIA PRÉVIA para obtenção do certificado de registro do estabelecimento</span></span></span>
        </td>
      </tr>
    </table>
