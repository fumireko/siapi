...
$nome_contador=$_POST["nome_resp"];
$cpf_cont=$_POST["cpf_resp"];
$rgcont=$_POST["rg_resp"];

$end_contador=$_POST["end_resp"];
$cep_contador=$_POST["cep_resp"];
$cidade_contador=$_POST["mun_resp"];
$bairro_contador=$_POST["bairro_resp"];
$fone_contador=$_POST["fone_resp"];

$mail_contador=$_POST["mail_resp"];
