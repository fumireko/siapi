...
<body>
    ...
    <div class="clearfix"></div>
        ...
        <header class="panel_header">
                <h2 class="title pull-left">Matricular <?php echo $motivo;?></h2>
         ...
         <?php
            ...
            tbcmei.tbcmei_nome
             ...
             where tbfila_motivo like '%".$motivo."%' 
             and tbaluno_turma = '".$turma."' 
                                ...
                                <tbody>
                                        <tr>
                                           <td align ="center"> <a href="../admin/alterafila.php?tbfila_id=<?php echo $id_fila;?>&ordem=<?php echo $ordem;?>"><?php echo $id_fila;?></a>         
                                            ...
                                            <td><a href='confrmatricula.php?tbfila_id=<?php echo $id_fila;?>&ordem=<?php echo $ordem;?>' class='btn btn-primary'>Matricular</a></td>
                                        </tr>
                                </tbody>
                                <?php
                                }    
