...
$sql = "SELECT * from tbequip  where tbequip.tbequip_id = '$tbequip_id' ORDER BY tbequip_id";
...
{
    $unidade_id = $ln['tbequi_tbcmei_id'];
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt-BR" lang="pt-BR" ng-app="App">
    ...
    <!-- BEGIN BODY -->
    <body>
     <script type="text/javascript" src="ajaxbs_local2.js"> </script>
      <script>
   ...
   getDados();
    ...
    <header class="panel_header">
            <h2 class="title pull-left">Alterando local do equipamento CTI  <?php echo $ctrl_ti; ?></h2><br />
       <a href="editaequip2.php?tbequip_id= <?php echo $tbequip_id; ?>" title="Alterar Dados do Equipamento">Alterar Dados do Equipamento</a>
    ...
    <fieldset>
            ...
            <div class="col-md-4">
            <input id="objeto" name="nsolicitante" id="nsolicitante" type="text" value = "<?php echo nomedolocal($conn,$unidade_id)  ;?>"
      ...
      ?>     
                   ...
                   <input  name="responsavel" id="responsavel" type="text" title="Digite o Nome do Responsavel"  value = "<?php echo $ln['tbequip_resp']; ?>"
                    placeholder="<?php echo $prov_resp; ?>"   class="form-control input-md" disabled> 
                    </div>
                    </div>              
                    ...
                    <!-- Text input-->
                     <div class="form-group" id="justificativa">
                            ...
                            <div class="col-md-4">
                            <textarea id="modelprocessador" name="modelprocessador" style="resize:none"
                            rows="2" placeholder="PROBLEMA" class="form-control input-md" disabled > 
                ...
                <div class="form-group" id="justificativa">
                            ...
                            <div class="col-md-4">
                            <textarea id="descplaca" name="descplaca" style="resize:none"
                            rows="2" placeholder="PROBLEMA" class="form-control input-md" disabled >
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                   <input  name="tipo_equip" id="tipo_equip" type="text" value = "<?php echo $ln['tbequi_tipo']; ?>"
                    placeholder="Desktop , Notebook , Tablet , Servidor ou Outros" class="form-control input-md" disabled> 
               </div>
                    </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                   <input  name="monitor"  type="text" value = "<?php echo $ln['tbequip_monitor']; ?>"
                    placeholder="Monitor" class="form-control input-md" disabled> 
               </div>
                    </div>
    ...
    <!-- Text input-->
            <div class="form-group">
              <label class="col-md-4 control-label" for="telefone">Monitor Nº: </label>
                  <div class="col-md-4">
                   ...
                   <input  name="util_num" id="util_num"  type="text" value = "<?php echo $ln['tbequip_util_num']; ?>"
                    ...
                    <div class="col-md-4">
                         <textarea id="util_nomes" name="util_nomes" style="resize:none"
                            rows="3" placeholder="Nomes dos utilizadores" class="form-control input-md" disabled >
