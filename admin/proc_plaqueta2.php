            ...
            if ($tp_equip == "M") // monitores
            {
                echo " 
                        <tr style='background-color: #FBD603'>            
                            ...
                            <td> &nbsp  $tab_cam  &nbsp</td>
                            <td> <a href=ret_dadosm.php?id=" . $campo . "> Visualizar</a> </td>	                      
                </tr>
                      ";
            }
            else  // diversos
             {
                if (($tp_equip == "D")||($tp_equip == "I")||($tp_equip == "R")||($tp_equip == "S")||($tp_equip == "T")||($tp_equip == "P")) // diversos
                {
                    echo " 
                        <tr style='background-color: #FBD603'>            
                            <td> &nbsp Codigo de Controle   $plaqueta</td>
                            ...
                            <td> &nbsp  $tab_cam  &nbsp</td>
                            <td> <a href=ret_dadosd.php?id=" . $tbequip_id . "> Visualizar</a> </td>	                      
                 </tr>
                      ";
...
//                    echo "<div>";
  //                 echo " <a href=cadequipsdiv.php?pat=".$campo."&loc=".$id_loc."&sec=".$id_sec."&tipo=".$id_tipo."  > Cadastrar </a>";
    //                echo "</div>";
