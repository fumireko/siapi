...
<html>
	...
	<script src="js/java_busplaqdiv.js"></script>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            ...
                            <form method="post" action="direciona2.php">    
                                ...
                                <div>  
                             <label>Numero de Controle de T.I :</label>  
                                </div>
                                <div>
                                    <input  type="text"  id="plaqueta"  name="plaqueta" title=" Digite o numero de Controle T.I  para checagem "type="text"  size = "30" >
                                  ...
                                  <div id="resultado">
                                    ...
                                    $ref = "vazio..";
                                    $sql = $mysqli->prepare("select id,ctrl_ti,tab_cam ,tab_chave from tb_controle_ti where ctrl_ti ='" . $ref . "' ORDER BY id");
                                    ...
                                    $sql->execute();
                                    $sql->bind_result($id, $ctrl_ti, $cam, $pos);
                                    ...
                                    while ($sql->fetch()) {
                                        echo "
                                            <tr>
                                            <td>$cam</td>
                                            <td> <a href=nota_ind.php?parametro=" . $cam . "></a> </td>	              
