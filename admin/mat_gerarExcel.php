...
if(mysql_num_rows($consultaMat) > 0){
    while(list($id_aluno, $nm_aluno,$n_mae,$telefone,$celu,$celular ,$data, $aluno_turma, $id_fila, $id_fila_aluno, $dtcad, $fila_motivo, $fila_id_cmei, $cmei_id_cmei) = mysql_fetch_array($consultaMat)){
        $ordem++;
