            ...
            <div class="content-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                            <form class="form-horizontal" method="POST" id="PDF" action="satas.php" enctype="multipart/form-data">
                                <!-- SEMED-->
                                    <!-- Pdf input-->
                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="arquivo">Atas Renovação</label>
                                        <input id="tipo_documento" name="tipo_documento" type="text" value="14" hidden>
                                        <div class="col-md-4">
