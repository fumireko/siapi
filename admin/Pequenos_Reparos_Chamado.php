...
<?php
  ...
  $sql = "SELECT * FROM solicitacao_servicos WHERE categoria = 'Pequenos Reparos/Chamado' ORDER BY id_solicitacao";
...
<?php
                                ...
                                ?>
                                        <tr>
                                            <td><a class="btn btn-primary" href="infChama.php?id_solicitacao=<?php echo $ln['id_solicitacao']?>"><?php echo $ln['id_pedido'];?>/<?php echo $ln['ano_pedido'];?></a></td>
                                            <td>N°<?php echo $ln['num_pedido'];?></td>
                                            <td><?php echo $dt;?></td>
                                            <td><?php echo $ln['unidade'];?></td>
                                            <td><?php echo $ln['tipo_servico'];?></td>
                                            <td><?php echo $ln['status_obra'];?></td>
                                            <td><a href="comentario_servico.php?id_solicitacao=<?php echo $ln['id_solicitacao']?>">Registro</a></td>
                                            <td><a href="fimservico.php?id_solicitacao=<?php echo $ln['id_solicitacao']?>">Finalizar</a></td>
                                        </tr>
                                <?php
                                }    
                                ?>    
