...
<body >
    ...
    <div class="clearfix"></div>
        ...
        <header class="panel_header">
                <h2 class="title pull-left">Computadores </h2> <?php echo $regiao;?>
         ...
         <!-- Dados do atendimento-->
          ...
          //  $get= "&regiao=".$_REQUEST['regiao'];
            ...
            <tr>
                ...
                data-placement="top"><u class='text-dark'><?php echo $ln['ctrl_ti'];?></u></a></td>
                ...
                <td><a href="del_equip.php?tbequip_id=<?php echo $ln['tbequip_id']?>">Excluir</a><a href="qrimpressao.php?var=<?php echo $ln['tbequip_id'] ?>"> QRCode</a></td>
            </tr>
            <?php
            }    
            ?>    
