...
<body >
    ...
    <div class="clearfix"></div>
        ...
        <header class="panel_header">
         ...
         <!-- Dados do atendimento-->
            ...
            <div  id="consulta">
            <form id="form1" name="form1" method="post" action="relfinalizados.php" enctype="multipart/form-data">
            <table>
            <tr> 
  ...
  if($requisicao ){
    ...
    and tbldados.dtafin >= '2022-11-18'
   ...
   $sql.=" LIMIT ".$inicio.",". $quantidade;
        ...
        and tbldados.dtafin >= '2022-11-18'
	ORDER BY id_dados desc LIMIT " . $inicio . ',' . $quantidade;
        //	ORDER BY id_dados desc;
  ...
  ?>
            ...
            <tr>
                ...
                <td><a href="impchamado.php?id_dados=<?php echo $ln['id_dados'];?>" rel="tooltip" data-color-class = "primary" data-animate=" animated fadeIn" 
