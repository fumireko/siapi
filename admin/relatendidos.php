...
<body>
    ...
    <div class="clearfix"></div>
        ...
        <header class="panel_header">
         ...
         <!-- Dados do atendimento-->
            ...
            <div  id="consulta">
            <form id="form1" name="form1" method="post" action="relatendidos.php" enctype="multipart/form-data">
            <table>
            <tr> 
            <div> 
                <td> Status </td>
  ...
  ?>
            ...
            <tr>
                ...
                <td><a href="imprimir?id_dados=<?php echo $ln['id_dados']?>">Imprimir</a></td>
