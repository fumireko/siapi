                                   ...
                                   //  echo $ret_cod_desc;
												   ...
												   ?>
																...
																<h2 class="title pull-left"> <?php echo $nomeunidade; ?></h2>                                
																  ...
																  <label >Marca : </label>    
																	...
																	&nbsp	&nbsp &nbsp
																  	  <label >Dt Cad : </label>    
																		&nbsp
																	  <input name="so_tipo"  style="background-color:seashell;" type="text" id="so_tipo" size="19" value=" <?php echo $ret_data; ?>" readonly />      
																		&nbsp &nbsp
																	 ...
																	 <label class="col-md-4 control-label" for="telefone">Novo Local: : </label>
																		<select class="form-control m-bot15" name="novaunidade_id">
																				  ...
																				  while ($row = mysqli_fetch_array($resultado)) {
																					  ...
																					  ?>
																			        <option  value="<?php echo $row['tbcmei_id']; ?> <?php echo $selected; ?>" title="<?php echo $row['tbcmei_id']; ?>"   >  <?php echo $row['tbcmei_nome']; ?></option>
																		       	<?php
																				  }
																				  ?>
             														</select>
																...
																<br />
															        ...
															        <a href="busca_diversos.php?tbequip_id= <?php echo $ret_ctrl_ti; ?>" title="Consultar  Dados do Equipamento">Consultar Infs do Equipamento</a><br /><br />                           
														           </div>
															</form>
															</div>
														</section></div>
