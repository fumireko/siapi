                        ...
                        <section class="box ">
                            ...
                            <form method="post" action="direciona.php">    
                             ...
                             <label>Tipo de Dispositivo a ser cadastrado :  
                                ...
                                <div>
                                  <select name="tipo" title="Selecione uma opção"  style="background-color:#FEFFFC"  onchange="preencheCampo(this);">
...
<option value=" ADRIANA DA SILVA "> ADRIANA DA SILVA </option>
<option value=" ADRIANA DA SILVA "> ADRIANA DA SILVA </option>
