                     ...
                     /*                  $query = "select id,ctrl_ti,tab_chave,tab_origem  from tb_controle_ti where ctrl_ti ='" . $ret_id . "'";
                                         ...
                                         ?>
                                                                                ...
                                                                                <form method="post" action="edita.php">
                                                                                  ...
                                                                                  <input type="hidden" name="sec_id" size=50 value= "">
                                                                                    ...
                                                                                    <section class="box ">
                                                                                 <header class="panel_header">
                                                                                <h2 class="title pull-left"> <?php echo $nome_local. "  ---  Dispositivo nao localizado ". " --   Tab tbequip  ID  " . $ret_id; ?></h2>                                
                             ...
                             <div>
                              ...
                              ?>
                                ...
                                <br>
                            <div>
                            <a href="editaequip.php?tbequip_id= <?php echo $ret_id; ?>" title="Alterar Local do Equipamento">Alterar Local do Equipamento</a><br />
							...
							<a href="qrimpressao.php?var= <?php echo $ret_ctrl_ti; ?>"  title="QR code do Equipamento">Gerar QR Code do Equipamento</a><br />
						   </div>
                              <?php
                                 }
