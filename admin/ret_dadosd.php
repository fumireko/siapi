                                    ...
                                    <i class="box_close fa fa-times"></i>
                                           ...
                                           <div>  
                                               <?php echo "Controle T.I. ".$ret; ?> 
                                                ...
                                                &nbsp &nbsp
                                                <input id="plaqueta" name="plaqueta"  style="background-color:seashell;" type="text" placeholder="Numero da Plaqueta " readonly size = "8" value=" <?php echo $ret; ?> ">
                                                &nbsp &nbsp <label for="coord">Nome do Equipamento : </label>    
                                                &nbsp &nbsp
                                                <input id="nome_equip" name="nome_equip" style="background-color:seashell;" type="text" placeholder="Nome do Computador " readonly size = "10" value=" <?php echo $ret; ?>">
												 ...
												 switch ($ret_cod_desc)
													...
													?>
															...
															<br>	<div>
															  ...
															  <br />&nbsp  <?php echo "    <sup> Cadastrado por : " . $ret_tec . "  em  " . $ret_datalanc . "    </sup>"; ?>     &nbsp  &nbsp  									 
																	 <br>					
															...
															<a href="busca_diversos.php?tbequip_id= <?php echo $ret_id; ?>" title="Alterar Dados do Equipamento">Consultar Infs do Equipamento</a><br /><br />                           
														      <a href="retira_equip.php?cti= <?php echo $ret_ctrl_ti; ?>"  title="Excluir Equipamento">Excluir Equipamento</a><br /><br />                           						  
																	 </div>
															</form>
															</div>
														</section></div>
												  ...
												  <?php
													break; 
														...
														?>
															...
															<br />&nbsp  <?php echo "    <sup> Cadastrado por : " . $ret_tec . "  em  " . $ret_datalanc . "    </sup>"; ?>     &nbsp  &nbsp  									 
																	 <br>					
														  	<a href="editaequip2d_loc.php?ip_id= <?php echo $ret_id; ?>" title="Alterar Local do Equipamento">Alterar Local do Equipamento</a><br /><br />
															<a href="editaequip2d.php?tbequip_id= <?php echo $ret_id; ?>" title="Alterar Dados do Equipamento">Alterar Dados do Equipamento</a><br /><br />
															<a href="busca_diversos.php?tbequip_id= <?php echo $ret_id; ?>" title="Alterar Dados do Equipamento">Consultar Infs do Equipamento</a><br /><br />                           
														     <a href="retira_equip.php?cti= <?php echo $ret_ctrl_ti; ?>"  title="Excluir Equipamento">Excluir Equipamento</a><br /><br />                           						  
																	 </div>
																	...
																	<i class="box_close fa fa-times"></i>
																		   ...
																		   <div>  
																			<?php echo "<i> Controle T.I. " . $ret_ctrl_ti . " </i> "; ?> 
																				 ...
																				 <label for="coord">Patrimonio :</label>    
																				&nbsp
																				<input id="plaqueta" name="plaqueta"  style="background-color:seashell;" type="text" placeholder="Numero da Plaqueta " readonly size = "8" value=" <?php echo $ret_plaqueta; ?>">
																				&nbsp <label for="coord">Nome do Equipamento : </label>    
																				&nbsp
																				<input id="nome_equip" name="nome_equip" style="background-color:seashell;" type="text" placeholder="Nome do Computador " readonly size = "8" value=" <?php echo $ret_nome; ?>">
																				 &nbsp &nbsp <label >IP : </label>    
																			 <input name="so_arq"  style="background-color:seashell;" type="text" id="so_arq" size="9" value=" <?php echo $ret_ip; ?>" readonly />      
																			    &nbsp &nbsp <label >Rack : </label>    
																			 <input name="so_arq"  style="background-color:seashell;" type="text" id="so_arq" size="5" value=" <?php echo $ret_rack; ?>" readonly />      
																	   </div>  
																<br><div>
																  <label >Gerenciavel : </label>    
																		&nbsp &nbsp
																	  <input name="so_tipo"  style="background-color:seashell;" type="text" id="so_tipo" size="3" value=" <?php echo $ret_gerenciavel; ?>" readonly />      
																	&nbsp	&nbsp &nbsp
																  <label >Portas Totais : </label>    
																		&nbsp
																	  <input name="so_tipo"  style="background-color:seashell;" type="text" id="so_tipo" size="3" value=" <?php echo $ret_por_total; ?>" readonly />      
																	&nbsp	&nbsp &nbsp
																  <label >Portas Uso : </label>    
																		&nbsp
																	  <input name="so_tipo"  style="background-color:seashell;" type="text" id="so_tipo" size="3" value=" <?php echo $ret_por_util; ?>" readonly />      
																		&nbsp &nbsp
																  <label >Portas Livres : </label> &nbsp   
																		 <input name="so_tipo"  style="background-color:seashell;" type="text" id="so_tipo" size="3" value=" <?php echo $ret_por_disp; ?>" readonly />      
																		&nbsp &nbsp
																 </div>  
															<br><div>
																  <label> Local :     </label>
                                     ...
                                     case '5':  // impressora
                                     {
                                         ?>
																...
																<br><div>
																	...
																	&nbsp &nbsp 	 <label >Componentes : </label>    
																		&nbsp &nbsp
																...
																<div class="actions panel_actions pull-right">
																	...
																	<i class="box_close fa fa-times"></i>
																		   ...
																		   <div>  
																				...
																				&nbsp &nbsp &nbsp &nbsp	&nbsp &nbsp   	<?php echo "<i>   Patrimonio . " . $ret_plaqueta . " </i> "; ?> 
																  ...
																  &nbsp &nbsp 	 <label >Marca : </label>    &nbsp &nbsp
																	  <input name="so_arq"  style="background-color:seashell;" type="text" id="so_arq" size="35" value=" <?php echo $ret_marca; ?>" readonly />      
                                             ...
                                             ?>
																...
																<div class="actions panel_actions pull-right">
																  ...
																  <label> Descriçao  :     </label>
																 	 &nbsp   <input name="placa"  style="background-color:seashell;" type="text" id="placa" size="80" value=" <?php echo $ret_comps  ; ?>" readonly />      
																</div>
															...
															<br>	<div>
																...
																<br><div>
																  <label> Obs :     </label>
																   <input name="placa"  style="background-color:seashell;" type="text" id="placa" size="86" value=" <?php echo   $ret_obs; ?>" readonly />      
																</div>
                                             ...
                                             ?>
																...
																<div class="actions panel_actions pull-right">
																  ...
																  &nbsp &nbsp 	 <label >Marca : </label>    &nbsp &nbsp
																	 ...
																	 <br><div>
																  <label> Descriçao  :     </label>
																 	 &nbsp   <input name="placa"  style="background-color:seashell;" type="text" id="placa" size="80" value=" <?php echo $ret_comps." `Tipo  ".$ret_posicao; ?>" readonly />      
																</div>
