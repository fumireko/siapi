...
<body>
    ...
    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
        <div class="page-title">
            <div class="pull-left">
                <h1 class="title">Sistema de Gestao Escolar Caec - Triagem</h1>
            </div>
        </div>
    </div>
    <div class="clearfix"></div>
        ...
        <header class="panel_header">
                <h2 class="title pull-left">MINHA LISTA TRIAGEM <?php echo $id_cmei;?></h2>                    
        </header>
         <!-- Dados do aluno-->
         <?php
            ...
            tbcmei.tbcmei_nome
             ...
             where tbcmei.tbcmei_id = '".$id_cmei."'
