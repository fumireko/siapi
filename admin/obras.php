...
<?php
  ...
  $sql = "SELECT * FROM solicitacao_servicos WHERE categoria = 'Incompleto' ORDER BY id_solicitacao";
...
<?php
                                ...
                                ?>
                                        <tr>
                                            <td><a class="btn btn-primary" href="infObra.php?id_solicitacao=<?php echo $ln['id_solicitacao']?>"><?php echo $ln['id_pedido'];?>/<?php echo $ln['ano_pedido'];?></a></td>
