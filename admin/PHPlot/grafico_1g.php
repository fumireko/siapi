...
function ret_Qtd_Pcby2mon($Fconexao, $Fref) // informa qtd de pcs por secretaria
{
...
# Data for bar chart:
$data = array(
    array('2 Monitores', ret_Qtd_Pcby2Mon($conn, "22"))
);
/*
 $data = array(
...
<body>
<h1>Dispositivos com 2 Monitores</h1>
<map name="map1">
<?php echo $image_map; ?>
</map>
...
<table>
  ...
  <tbody>
    <tr>
      <th scope="row">2</th>
      <td><?php echo ret_Qtd_Pcby2Mon($conn, "22"); ?> </td>
    </tr>
  ...
  <a href="../tabelas_abas_ver.php?campo=VAZIO&busca=VAZIO&tipo=mon_2a">Visualizar Equipamentos com 2  Monitores cadastrado(s)</a><br /> <br />
