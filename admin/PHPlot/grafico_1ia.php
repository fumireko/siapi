...
function ret_Qtd_Pcby0mon($Fconexao, $Fref) // informa qtd de pcs com base em tbequip
{
...
function ret_Qtd_Pcby0mon_v1($Fconexao, $Fref) // informa qtd de pcs com base em controle_ti
{
    //	echo "<center> ".nomedesecretaria($conn,$campo)."</center>";				 
    $conn = $Fconexao;
    $conteudo = "";
...
# Data for bar chart:
$data = array(
    array('0 Monitores', ret_Qtd_Pcby0Mon_v1($conn, "22"))
);
...
<body>
<h1>Dispositivos sem Monitor Cadastrado</h1>
<map name="map1">
<?php echo $image_map; ?>
</map>
...
<table>
  ...
  <tbody>
    <tr>
      <th scope="row"></th>
      <td><?php echo ret_Qtd_Pcby0Mon_v1($conn, "22"); ?> </td>
    </tr>
...
<a href="../tabelas_abas_ver.php?campo=VAZIO&busca=VAZIO&tipo=mon_0">Visualizar Equipamentos sem  Monitores cadastrado(s)</a><br /> <br />
