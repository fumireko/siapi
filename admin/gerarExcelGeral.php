...
header("Content-Disposition: attachment; filename=Geral.xls");  //File name extension was wrong
header("Expires: 0");
...
$consultaMat = mysql_query("select * from tbrecad order by tbrec_id") or die('Erro, query falhou');
