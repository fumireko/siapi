...
if (isset($_GET['ctrl_ti']))
    $retorno_ini = $_GET['ctrl_ti'];
else
    if (isset($_GET['tbequip_id'])){
        $retorno_ini = $_GET['tbequip_id'];
    }
    //$retorno_ini = $_GET['tbequip_id']; 
$retorno = $retorno_ini; //  $_GET['tbequip_id']; {
...
//echo "<br> Equipamento Codigo ".$tbequip_id;
    ...
    if (($tp_equip == "C")and($tab=="1"))  // visualiza Computadores
    {
	...
	<?php
        ...
        if (($tp_equip == "I") and($tab=="2")) // visualiza Impressoras 
        {
      ...
      <?php
            ...
            if (($tp_equip == "M")and($tab=="3"))  // visualiza Monitor
            {
      ...
      <?php
                    ...
                    if (($tp_equip == "S")and($tab=="2")) // visualiza Switch
                    {
                        $sql = "SELECT tb_diversos.id,
					tb_diversos.descricao,
					tb_diversos.descricao_cod,
      ...
      <?php
                        ...
                        if (($tp_equip == "T")||($tp_equip == "N")||($tp_equip == "A")||($tp_equip == "C")||($tp_equip == "M") || ($tp_equip == "W"))  // visualiza Tv , No-break ,Acess Point , Controlador ou Modulo de baterira ...
                        {
                                $sql = "SELECT tb_diversos.id,
					tb_diversos.descricao,
					tb_diversos.descricao_cod,
