...
if($_FILES) { // Verificando se existe o envio de arquivos.
    ...
    $dir = 'upload/comeco_obras/'; // Diretório que vai receber o arquivo.
  ...
  mysql_free_result($result);
    ...
    $sqlinsert  = "INSERT INTO  semed.comprovantes(nome, id_obra, tipo) VALUES('$name', '$id_solicitacao', 'comeco');";
