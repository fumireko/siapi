...
<body >
    ...
    <div class="clearfix"></div>
        ...
        <header class="panel_header">
         ...
         <!-- Dados do atendimento-->
            ...
            <div  id="consulta">
            <form id="form1" name="form1" method="post" action="frmporstatus.php" enctype="multipart/form-data">
            <table>
            <tr> 
  ...
  if($_REQUEST['regiao'] ){
	...
	where tbldados.regiao LIKE '%".$_REQUEST['regiao']."%'
	and tbldados.status = 'pendente'
   	ORDER BY id_dados";
   $sql.=" LIMIT ".$inicio.",". $quantidade;
		...
		Inner Join tbcmei
		ON tbcmei.tbcmei_id = tbldados.id_setor  
		where tbldados.status = 'pendente'
            ...
            ?>      
             <tr>
                ...
                data-placement="top"><u class='text-dark'><?php echo $ln['id_dados'];?></u></a></td>
                 <?php
                 $str = $ln['solucao'];
                      if (strpos($str, 'PENDENCIA EXTERNA') !== false) 
                      {// echo 'Existe termo na string';
                      ?>
                ...
                <td style="background: #E7A693 "><?php echo $ln['solucao'];?></td>
                <td><?php echo $ln['tecnico'];?></td>
                <td><a href="satender.php?id_dados=<?php echo $ln['id_dados']?>">Atender</a></td>
                <td><a href="detalhar.php?id_dados=<?php echo $ln['id_dados']?>">Detalhar</a></td>
                <td><a href="sfinalizar.php?id_dados=<?php echo $ln['id_dados']?>">Finalizar</a></td>
