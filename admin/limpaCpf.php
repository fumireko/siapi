...
$cpf_mae = $_REQUEST['cpf_mae'];
echo $cpf_mae; echo '<br>';
    $valor = trim($valor);
...
{
	$sqlinsert  = "INSERT INTO  semed.tbaluno(tbaluno_nome,tbaluno_dtnasc,tbaluno_turma,tbaluno_nmae,tbaluno_cpfmae,tbaluno_tel,celu,celular,
