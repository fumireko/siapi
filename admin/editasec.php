...
<body>
    ...
    <div class="col-lg-12">
        ...
        $consulta = mysql_query("SELECT * from tbcmei where tbcmei_id = $id_depto");
        while($linhas = mysql_fetch_object($consulta)) {
        
        ?>
        <header class="panel_header">
        <h2 class="title pull-left"> Mudar secretaria </h2>
            </header>
            <div class="content-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <form class="form-horizontal" method="POST" id="seditasec.php" action = "seditasec.php">
                                <!-- Text input-->
                            <div class="form-row">
                                <label class="col control-label" for="cpf_estag">Nome departamento</label>
                               <div class="col">
                                <input type="hidden" name="id_depto" value="<?php echo $linhas->tbcmei_id ?>">  
                                <input id="aluno_id" name="nome_depto" type="text" disabled value="<?php echo $linhas->tbcmei_nome?>" placeholder="Nome Cmei"
                                class="form-control input-md">
                                </div>
                                <label class="col control-label" for="cpf_estag" >Secretaria</label>
                                <div class="col">
                                <select class="form-control m-bot15" name="tbcmei_sec_id" required>
			                        <option value=""></option>
			                        <?php
