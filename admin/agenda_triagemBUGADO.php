...
<body>
    ...
    <div class="clearfix"></div>
        ...
        <header class="panel_header">
         ...
         <!-- Dados do aluno-->  
         <form id="form1" name="form1" method="post" action = "agenda_triagem.php" enctype="multipart/form-data">
            <table> 
            <tr> 
         ...
         <?php
            ...
            usuarios.funcao
             ...
             and tbcaec.caec_status = 'Agendado'
                               ...
                               <?php
                                ...
                                <tbody>
                                        <tr>
                                            ...
                                            <?php if ($nivel == 5)
                                            {
                                             echo "<a href='./devtriagem.php?id_fila=$id_fila'>$id_fila</a>";   
                                            ...
                                            <td><a href="./devtriagem.php?id_fila=<?php echo $id_fila;?>" rel="tooltip" data-color-class = "primary" data-animate=" animated fadeIn" 
                                             data-toggle="tooltip" data-original-title="Editar?" 
                                             data-placement="top"><u class='text-dark'>Triar</u></a>
                                            </td>
                                                           ...
                                                           <?php
                                                            ...
                                                            <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <?php if ($nivel == 5)
                                                                        {
                                                                         echo "<a href='./devtriagem.php?id_fila=$id_fila' class='btn btn-primary'>$id_fila</a>";   
