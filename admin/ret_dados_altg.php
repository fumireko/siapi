                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                          ...
                          <div class="content-body">
                              <h5 class="title pull-left">Registros  T.I. <  <?php echo $hoje; ?>        > 
                                </h5>
                            <br />
                                <h5 class="title pull-left">  <?php echo " <B>CONTROLE T.I.  Nº ".$ret_id."</B>"; ?>   
                                 ...
                                 if (($ret_id=="")||($ret_id=="0")) 
                                 {
                                     echo " <br><br><b> Nenhum dado foi inserido na busca !   </b> <br>";
                                 ...
                                 else
                                 {
                                     if (($ret_id == "GERAL"))
                                     {
                                         ...
                                         ";
                                             do {
                                                 ...
                                                 if ($ret_tabela == "1") {
                                                     ...
                                                     $pagina = "ret_dados.php?id=" . $ret_tab_id;
                                                 } else
                                                     if ($ret_tabela == "2") {
                                                         ...
                                                         if ($ret_tabela == "3") {
                                                             ...
                                                             $pagina = "ret_dadosm.php?id=" . $ret_tab_id;
                                                         } else {
                                       ...
                                       {
                                         $query = "select * from tb_registra  where ctrl_ti ='" . $ret_id . "' order by id desc";
                                         $dados = mysqli_query($conn, $query);
                                         $resultadoDaInsercao = mysqli_num_rows($dados);
                                         if ($resultadoDaInsercao == '0') {
                                             echo " <br><br><b> Sem Registros de  Alteraçoes no controle  " . $ret_id . " </b>";
