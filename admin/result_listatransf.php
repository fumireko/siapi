...
<body>
    ...
    <div class="clearfix"></div>
        ...
        <header class="panel_header">
                <h2 class="title pull-left">Fila de transferência para matricula </h2>
        </header>
        <header class="panel_header">
                <h2 class="title pull-left">Meu cmei  <?php echo $tbcmei_nome?> </h2>            
        </header>

        </header>
        <header class="panel_header">
                <h2 class="title pull-left">Id Cmei da Fila <?php echo $id_cmei?> </h2>            
        </header>
         ...
         <?php
            ...
            where tbtran_status = 'Transferencia'
            and tbaluno_turma like '%".$_REQUEST['turma']."%' 
            and tbtran.tbcmei_tbcmcei_id = '".$id_cmei."' 
            ORDER BY tbtran_id";
