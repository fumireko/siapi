                        ...
                        <section class="box ">
                            ...
                            <form method="post" action="direciona.php">    
                             ...
                             <label>Tipo de Dispositivo a ser cadastrado :  
                                ...
                                <div>
                                  <select name="tipo" title="Selecione uma opção"  style="background-color:#FEFFFC" class="form-control selectClass show-tick show-menu-arrow" onchange="preencheCampo(this);">
                                                        <option value="0"></option>
                                                        <option value="Micro-computador">Micro-computador</option>
                                                        <option value="Kit(s) Micro-computador">Kit(s) - Micro-computador</option>                  
                                                        <option value="Multiplos Pcs">Multiplos Pcs</option>                  
                             ...
                             <div>
                                 <textarea id="modelo" name="modelo" style="resize:none"
                            rows="3"  placeholder="PROCESSADOR / MODELO" class="form-control input-md"  >                            
                                </textarea> 

                                  <input  type="text"  id="modelo2"  name="modelo2" type="text"   size = "10" >
