    ...
    <div class="col-lg-12">
        <section class="box ">
            <header class="panel_header">
                <h2 class="title pull-left">Pesquisa</h2>
            </header>
            <div class="content-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                    <form class="form-horizontal" id="form1" name="form1" method="post" action="incpornome.php" enctype="multipart/form-data">                            <div id="MsgSucesso" class="alert alert-success" style="text-align:center; display:none;" role="alert">Unidade cadastrada com sucesso!</div>
