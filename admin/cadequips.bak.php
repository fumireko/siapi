   ...
   <body>
      ...
      <form method="post" enctype="multipart/form-data" action="salvaequip2.php">
         ...
         <div class="container">
            ...
            <?php echo "<i>  Controle T.i. " . $ret_plaq . " </i> "; ?>        <label  class="control-label">    </label>     <a href='newsfeed.php'  >menu inicial </a> 
...
<?php
  ...
  <a href="caddiversos.php?loc=liberado&tipo=7" title="adicionar Kit nao cadastrado   ">+</a><br /><br />
   ...
   <body>
      ...
      <form method="post" enctype="multipart/form-data" action="salvaequip2.php">
         ...
         <div class="container">
            ...
            <?php echo "<i>  Controle T.i. " . $ret_plaq . " </i> "; ?>        <label  class="control-label">    </label>     <a href=cadequips1.php?<?php echo $ret_caminho ; ?>  >Ocultar menu </a> 
            <ul class="nav nav-tabs">
               <li class="active"><a data-toggle="tab" href="#home">Dados Equipamentos</a></li>
               <li><a data-toggle="tab" href="#menu1">Componentes</a></li>
               <li><a data-toggle="tab" href="#menu2">utilizadores</a></li>
