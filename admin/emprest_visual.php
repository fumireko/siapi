...
$ret_tipo = $_GET['tipo']; // RECEBE o tipo de consulta 

if ($ret_tipo=='1')
 {
          $query = "select * from tb_emprestimo where status ='0' ";
                                          ...
                                          <style>
                                           ...
                                           getDados();
                                            ...
                                            <header class="panel_header">
                                                    <h2 class="title pull-left">Visualizar Emprestimos Devolvidos em equipamento  </h2><br />
...
else // retorno de dados na tabela 
{
                            ...
                            <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt-BR" lang="pt-BR" ng-app="App">
                              ...
                              <style>
                               ...
                               getDados();
                                ...
                                <section class="box ">
                                <header class="panel_header">
                                        <h2 class="title pull-left">Visualizar Emprestimo devolvidos de equipamentos  </h2><br />
...
else
 {
   if ($ret_tipo=='2')
   {
       $query = "select * from tb_emprestimo where status ='1' ";
           $dados = mysqli_query($conn, $query);
           $resultadoDaInsercao = mysqli_num_rows($dados);
           $linha = mysqli_fetch_assoc($dados);
                                        ...
                                        <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt-BR" lang="pt-BR" ng-app="App">
                                          ...
                                          <style>
                                           ...
                                           getDados();
                                            ...
                                            <section class="box ">
                                            <header class="panel_header">
                                                    <h2 class="title pull-left">Visualizar Emprestimos PENDENTES em equipamento  </h2><br />
                            ...
                            <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt-BR" lang="pt-BR" ng-app="App">
                              ...
                              <style>
                               ...
                               getDados();
                                ...
                                <section class="box ">
                                <header class="panel_header">
                                        <h2 class="title pull-left">Visualizar Emprestimo PENDENTES de equipamentos  </h2><br />
                                                ...
                                                do {
                                                  //  $linha = mysqli_fetch_assoc($dados);
                                                    ...
                                                    <td><?php echo $linha['status']; ?> </td>
                                                        <td><?php echo $linha['previsao']; ?> </td>
                                                    <td><?php echo $linha['data_cad']; ?> </td>
                                                    <td><span class="label label-info">Não Devolvido</span> </td>
                                                        <td><?php echo $linha['nome_solicitante']; ?> </td>
                                                    <td title=" <?php echo $linha['temp']; ?>   "  ><?php echo $linha['cti']; ?> </td>
                                                  </tr>
                                               <?php
