                        ...
                        <section class="box ">
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                         <h4 class="title pull-left"> <?php echo " Manutençao de Reservas CTI"; ?></h4>                                
                            ...
                            <form method="post" action="reserva_cti_salva.php">    
                            ...
                            <div>
                                ...
                                <button id="btn_cadastro_unidade" name="btn_cadastro_unidade" class="btn btn-primary">Armazenar</button>
                                 ...
                                 <a href="verifica_qr_cti.php?tipo=1" title="Verifica QR Distribuidos/Utilizados">Visualiza QR Distribuidos por Usuario </a><br /><br />
                                  ...
                                  <a href="reserva_cti_consulta.php?tipo=1" title="Verifica CTI Reservados/Utilizados">Visualiza CTI em Reserva  </a><br /><br />
                                </div>
                            </form>
                            </div>
                        </section></div>
