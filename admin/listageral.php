...
<body>
    ...
    <div class="clearfix"></div>
        ...
        <header class="panel_header">
                ...
                <h2 class="title pull-left">Lista GERAL</h2>
                     
        </header>
        <a id="gerarExcel" href="gerarExcelGeral.php" class="btn btn-primary">Gerar Relatório</a>  
         <!-- Dados do atendimento-->
            ...
            $sql = "select * from tbrecad order by tbrec_id ";
