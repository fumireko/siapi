    ...
    case '1': // cadastro de micro computadorrs
        ...
        if ($ret_plaq == "") {
            ...
            ?>
                                            ...
                                            <h2>Cadastro de Equipamento ( PCs e Afins) </h2>  <?php echo "<i>  Controle T.I. " . $ret_plaq . " </i> "; ?>        <label  class="control-label">    </label>  &nbsp &nbsp  <a href=cadequips1.php?<?php echo $ret_caminho ; ?>  >Ocultar Menu </a> 
   ...
   case '20': {  // CADASTRO DE CRHOMEBOOKS
        ...
        if ($ret_plaq == "") {
            ...
            ?>
                                            ...
                                            <h2>Cadastro de Chromebook   </h2>  <?php echo "<i>  Controle T.I. " . $ret_plaq . " </i> "; ?>        <label  class="control-label">    </label>  &nbsp &nbsp  <a href=cadequips1.php?<?php echo $ret_caminho ; ?>  >Ocultar Menu </a> 
