...
$col = 6; // parametro de controle de colunas
...
else  // apto para continuidade de geracao de QrCode pois nao foram encontrados os numeros reservados ...
{
    ...
    if ($usados <> "") {  // informa os numeros ja usados na tabela controle_ti
        ...
        echo "<br><br>  <center> <input type='button' value='Voltar' onClick='JavaScript: window.history.back();'></center> ";
        echo " </b> </p> </center> </p> </body></html>";
    } else {  // tudo certo para a geracao dos arquivos 



        // inicio da rotina em escrever em arq texto //
        ...
        // fim da rotina de escrever  a numercao em arq texto
        ...
        if (($ret_inicio == "") or ($ret_fim == "0")) {
            ...
            for ($i = $ret_inicio; $i <= $ret_fim; $i++) {
                ...
                ?> 
                                 ...
                                 <?php
            } // fim do for inicio e fim da numeracao
...
} // fim do estar apto para qr codes 
