...
include "bco_fun.php";
$ret_id_cti = $_GET['cti'];
if(($ret_id_cti=="0")or($ret_id_cti==0))
{
   $nome_local = "Nenhum local encontrado";
   $ret = "VAZIO";
   echo " <h2> CTI : " . $ret_id_cti . " </h2> <h6>  < Codificacao :  " . $ret_id_cti . "   ( - vazio - )  > </h6>";
                          ...
                          <div class="content-body">
                            <div class="row">
                                 ...
                                 if ($resultadoDaInsercao == '0') {
                                     echo " <center> Controle  T.I   " . $ret_id_cti." INEXISTENTE !  </center>";
                                 }
                                else
                                 ...
                                 if (($ret_tipo == "1") and ($ret_id <> "0"))  // acesso a tabela equipamentos
                                 {
                                     ...
                                     if ($qtd == 0) {
                                         $nome_local = "Nenhum local encontrado";
                                         $ret = "VAZIO";
                                         echo " <h2> Controle CTI : " . $ret_id_cti . " </h2> <h6>  < Codificacao :  " . $ret_cam_id . "  tbequip :  - " . $ret_id . " - Vazio  > </h6>";
                                         echo "<img src='img/dispositivo.jpg' alt='Dispositivo nao Localizado' width='250' height='350'>";
                                     } else  // negativa de igual a zero no retorno do banco 
                                     {
                                         do {
                                                   ...
                                                   <form method="post" action="edita.php">
                                                          ...
                                                          <section class="box ">
                                                                    ...
                                                                    <div class="actions panel_actions pull-right">
                                                                        <h5> 	<?php echo " Codificacao : ".$codificacao."   </i> "; ?> </h5>
                                                                               ...
                                                                               &nbsp &nbsp      &nbsp &nbsp   <i style="color:red"> **   EQUIPAMENTO DESABILITADO * * </i>                 
                                                                                   </br> 
                                                          ...
                                                          <?php
                                                                ...
                                                                ?>
                                                                         ...
                                                                         <div>
                                                                        <a href="#" title="Ativar utilizaçao de do Equipamento" disabled>  Ativa Controle T.I do Equipamento (desabilitado)</a><br /><br />
                                                 ...
                                                 ?>
																...
																<div class="actions panel_actions pull-right">
																	...
																	<i class="box_close fa fa-times"></i>
																		   ...
																		   <div>  
																			<?php echo "<i> Controle T.I. " . $ret_ctrl_ti ."  Status : ".$ret_status. " - ".$codificacao." </i> "; ?> 
																			    &nbsp &nbsp      &nbsp &nbsp   <i style="color:red"> **   EQUIPAMENTO DESABILITADO * * </i>                 
                                                                               </br> 
																				 <label for="coord">Patrimonio :</label>    
																				&nbsp
