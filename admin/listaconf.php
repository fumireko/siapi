    ...
    <div class="clearfix"></div>
        ...
        <header class="panel_header">
         ...
         <!-- Dados do atendimento-->
            ...
            <div  id="consulta">
            <form id="form1" name="form1" method="post" action="listaconf.php" enctype="multipart/form-data">
            <table>
            <tr> 
            ...
            ?>
            <tr>
                <td><a href="editapecas.php?tbequip_id=<?php echo $ln['tbequip_id'];?>" rel="tooltip" data-color-class = "primary" data-animate=" animated fadeIn" 
