                                ...
                                <div class="Pagina">
                                    <div class="Recorte1">
                                      <div class="Recorte">
                                       ...
                                       <br /><br /><br /> <h6 style="color: black; font-family: Monaco; ">( <?php echo $parametro . "/" . $caminho . "/" . $ret_patrimonio . "/" . $ret_idloc; ?>  ) </h6>
                            ...
                            <div class="Pagina">
                                <div class="Recorte1">
                                  <div class="Recorte">
                                       <div class="boxmodel1">
                                        <img class="imglogo" src="img/Brasao.png" /> 
                                         <?php echo "<img  src='{$qrCodeName}'width='99px'height='61px'>"; ?>
                                   ...
                                   <br /><br /><br /> <h6 style="color: black; font-family: Monaco; ">( <?php echo $parametro . "/" . $caminho . "/" . $ret_patrimonio . "/" . $ret_idloc; ?>  ) </h6>
                                  <label> <strong> ****   Resumo da Busca  **** </strong> </label><br />
								 ...
								 <label> Equipamento Nome :  <?php echo $ret_nome; ?>   </label><br />
                                  ...
                                  <a href="qr_ind_ti.php?id=0" title="SELECIONAR ">Voltar   </a>  <br /><br />
                                   ...
                                   <br /><br /><br />
                                   <a href="qrimpressao_ti.php?var=<?php echo $parametro; ?> " title="Imprimir QR  ">Imprimir Qr Code   </a>  <br /><br />

                                   <br /><br /><br />
                                   <a href=" <?php echo $value ?>" title="Verificar dados completos ">Dados completos   </a>  <br /><br />
                                   <a href="qrimpressao_termo.php?var=<?php echo $parametro ?>" title="Ir para Local ">Termo de Responsabilidade   </a>  <br /><br />
                            </body>
