                        ...
                        <body >
                            ...
                            <div class="clearfix"></div>
                                ...
                                <header class="panel_header">
                                        <h2 class="title pull-left">Chamados 2025 SEDE</h2>
                   <h5 class="title pull-left"> <a id="gerarExcel" href="relfinalizados2.php" class="btn btn-primary">Dados sem Borda</a></h5>
                               </header>
                       ...
                       <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                        ...
                        <body >
                            ...
                            <div class="clearfix"></div>
                                ...
                                <header class="panel_header">
                                        <h2 class="title pull-left">Chamados 2025 SEDE</h2>
                   <h5 class="title pull-left"> <a id="gerarExcel" href="relfinalizados2.php?tipo=1" class="btn btn-primary">Dados com Borda</a></h5>
                               </header>
                                 <!-- Dados do atendimento-->
