    ...
    <div class="clearfix"></div>
        ...
        <header class="panel_header">
         ...
         <!-- Dados do atendimento-->
            ...
            <div  id="consulta">
            <form id="form1" name="form1" method="post" action="listavisitante.php" enctype="multipart/form-data">
            <table>
            <tr> 
            ...
            if($_REQUEST['regiao'] ){
              ...
              ON tbvisitante.visi_id = tbcmei.tbcmei_id   
            ...
            <?php
                ...
                while( $ln = mysql_fetch_assoc($qr) )
                {
                    ...
                    $dataentrada= implode("/",array_reverse(explode("-",$data_entrada)));

                    $data_saida = $ln['visi_dataentrada'];
                    $datasaida= implode("/",array_reverse(explode("-",$data_saida)));
