            ...
            <div class="content-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <form class="form-horizontal" method="POST" id="registro_servico" action = "registro_servico.php">
                        <tr> <td> <a id="gerarExcel" href="imp_Solicitacoes.php?id_solicitacao=<?php echo $id_solicitacao?>" class="btn btn-primary">Gerar Relatório</a> </td></tr>
                            <div class="form-row">
                                ...
                                <!-- Text input-->
                                <label for="registro">Registro da Obra Nº<?php echo $linhas->id_pedido?>/<?php echo $linhas->ano_pedido?></label>
                                <div class="col">
