            ...
            <div class="content-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                            <form class="form-horizontal" method="POST" id="PDF" action="scredenciamento.php" enctype="multipart/form-data">
                                <!-- NRE -->
                                    <!-- Pdf input-->
                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="arquivo">Credenciamento</label>
                                        <input id="tipo_documento" name="tipo_documento" type="text" value="15" hidden>
                                        <div class="col-md-4">
