         ...
         <section class="wrapper main-wrapper">
            <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
               <div class="page-title">
                  <div class="pull-left">
                     <h1 class="title">Encaminhamento triagem</h1>
                  </div>
               </div>
            </div>
            ...
            <section class="box ">
                ...
                <h2 class="title pull-left">Lista de espera</h2>
                </header>
                  ...
                  <div class="row">
                     <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group  col-md-6">
                            ...
                            <div class="row">
                            <div class="form-group  col-md-6">
                            <form class="form-horizontal" method="POST" id="busca_inc" action = "busca_inccaec.php">
                            <label class="col-md-4 control-label" for="dta_nasc">Data de nascimento</label>
                             ...
                             <thead>
                                   ...
                                   ENVIAR PARA TRIAGEM DO CAEC - <?PHP echo $tbcmei_nome;?> 
                                </p>
