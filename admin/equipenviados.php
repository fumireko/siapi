    ...
    <div class="clearfix"></div>
        ...
        <header class="panel_header">
         ...
         <!-- Dados do atendimento-->
            ...
            <div  id="consulta">
            <form id="form1" name="form1" method="post" action="equipenviados.php" enctype="multipart/form-data">
            <table>
            <tr> 
                ...
                <option value="">Geral</option>
			      <?php
			           ...
			           $resultado = mysql_query($sql) or die('Erro ao selecionar especialidade: ' .mysql_error());
			            ...
			            {
    	    	        $selected = ($row['tbcmei_nome'] == $_POST['tbcmei_nome'])?'selected':'';
			            ?>
                         <option value="<?php echo $row['tbcmei_nome'];?>"<?php echo $selected; ?>>
            ...
            <tr>
                ...
                <td><a href="imptransequip.php?tbtrasnfequip_id=<?php echo $ln['tbtrasnfequip_id'];?>" rel="tooltip" data-color-class = "primary" data-animate=" animated fadeIn" 
                 data-toggle="tooltip" data-original-title="Historico?" 
                 data-placement="top"  target="_balnk"><u class='text-dark'>Imprimir</u></a></td>
            </tr>
            <?php
            }    
            ?>    
