...
<body>
    ...
    <div class="col-lg-12">
        ...
        <header class="panel_header">
           <h2 class="title pull-left">Situação do Atendimento</h2>
            </header>
                        ...
                        <form class="form-horizontal" method="POST" id="updateAtendimento" action = "updateAtendimento.php">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    ...
                                    <input hidden id="status" name="status" type="text"  value="execução">
                                ...
                                <!-- Text input-->
                                <label for="registro">Registro da situação do atendimento</label>
                                <div class="col">
