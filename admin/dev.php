...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt-BR" lang="pt-BR" ng-app="App">
    ...
    <header class="panel_header">
            <h2 class="title pull-left">Agendar triagem <?php echo $cod; ?></h2>
            <div class="form-group  col-md-6">
            </div>
            <div class="actions panel_actions pull-right">
                 <a href='./lista_triagem.php' class='btn btn-primary'>Voltar</a>
                 <i class="box_toggle fa fa-chevron-down"></i>
                 <i class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></i>
                 <i class="box_close fa fa-times"></i>
            </div>
     </header>
    <form class="form-horizontal" method="POST" id="sdev" action="sdev.php">
    <fieldset>
              ...
              <div class="col-md-4">
               ...
               <!-- Text input-->
                     ...
                     <div class="form-group">
                        ...
                        <!-- Text input-->
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="email">Hora :</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                            <input id="email" name="datatriagem" id="datatriagem" type="date" value = "<?php echo $hoje;?>"
