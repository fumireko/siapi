                            ...
                            <div class="container-fluid">
                                <div class="form-horizontal meuform">
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        <div class="col-md-5">
                                            <label class="control-label">Modelo Placa</label>  <a href="" title="Adicionar nova Placa Mãe ">+</a>
                                          <?php
                                        ...
                                        <div class="col-md-6">
                                            <label  class="control-label">Modelo Processador</label>  <a href="" title="Adicionar novo Processador ">+</a>
                                           <?php
                                      ...
                                      <div class="col-md-5">  
                                            <label> </label>
                                                       <select title="Selecione uma opção" class="form-control selectClass show-tick show-menu-arrow" id="mon_tipo" name="mon_tipo"  >
                                                        ...
                                                        <option value="Unico" default>Unico</option>                
