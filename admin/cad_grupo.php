                        ...
                        <section class="box ">
                            ...
                            <div class="content-body">    <div class="row">
                             ...
                             <label>Local?: 
                                ...
                                <div>
                                <input id="coord" name="coord" type="text" placeholder="Digite o nome do(a) Diretor(a)" size = "60" required>
                                </div>  

                                <div>
                                  <label for="coord">Email</label>    
                               </div>        

                                <div>
                                <input id="coord" name="coord" type="text" placeholder="Digite o email" size = "60" required>
                                </div>  
