...
<body>
    ...
    <div class="col-lg-12">
        ...
        <h2 class="title pull-left">Núcleo Regional da Área Norte</h2>
            </header>
            <div class="content-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                            <form class="form-horizontal" method="POST" id="PDF" action="sEnFundamental.php" enctype="multipart/form-data">
                                <!-- NRE -->                                    
                                    <!-- Pdf input-->
                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="arquivo">Renovação Ensino Fundamental</label>
                                        <input id="tipo_documento" name="tipo_documento" type="text" value="17" hidden>
                                        <div class="col-md-4">
