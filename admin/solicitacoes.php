                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Pequenos Reparos/Chamado ou Obras</h2>
                            ...
                            <tr> <td> <a id="gerarExcel" href="Solicitacoes_gerarExcel.php?" class="btn btn-primary">Gerar Relatório</a> </td></tr>
...
<?php
  ...
  $sql = "SELECT * FROM solicitacao_servicos ORDER BY id_solicitacao";
...
<?php
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><a class="btn btn-primary" href="baixar.php?id_solicitacao=<?php echo $ln['id_solicitacao']?>">Documentos</a></td>
                                        </tr>
                                <?php
                                }    
                                ?>    
