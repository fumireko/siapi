...
<body>
    ...
    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
        <div class="page-title">
            <div class="pull-left">
                <h1 class="title">Sistema de Gestao T.I - Aguardando agenda para triagem</h1>
            </div>
        </div>
    </div>
        ...
        <header class="panel_header">
         ...
         <?php
            ...
            usuarios.funcao
             ...
             ?> 
              <tr> 
                <td> <a href='' class='btn btn-primary'>Nova busca</a> </td>
                <td> <a href='./agenda_triagem.php' class='btn btn-primary'>Agenda triagem</a> </td>
            </tr>
                               ...
                               <?php
                                ...
                                <tbody>
                                        <tr>
                                            ...
                                            <?php if ($nivel == 5)
                                            {
                                             echo "<a href='./dev.php?id_fila=$id_fila' class='btn btn-primary'>$id_fila</a>";   
                                            ...
                                            <td><?php 
                                                                        if ($status == 'Agendado')
                                                                        {
                                                                            echo "<a href='./imptriagem.php?id_fila=$id_fila' class='btn btn-primary'>$status</a>"; 
                                                                        }
                                                                        else 
                                                                           {
                                                                            echo "<a href='' class='btn btn-primary'>$status</a>"; 
                                                                           } 
