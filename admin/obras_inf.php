...
<body>
    ...
    <div class="col-lg-12">
        ...
        <header class="panel_header">
           <h2 class="title pull-left">Dados da Obra</h2>
            </header>
            <div class="content-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <form class="form-horizontal" method="POST" id="alterObra" action = "salva_obra.php">
                        <tr> <td> <a id="gerarExcel" href="imp_Solicitacoes.php?id_solicitacao=<?php echo $id_solicitacao?>" class="btn btn-primary">Gerar Relatório</a> </td></tr>
                                ...
                                <label class="col control-label" for="categoria">Categoria</label>
                                    <div class="col">
                                        <select id="categoria" name="categoria" class="form-control" 
                                            required>
                                            <option value="<?php echo $linhas->categoria?>"><?php echo $linhas->categoria?></option>
                                ...
                                <label class="col control-label" for="status">Status</label>
                                    <div class="col">
                                        <select id="status" name="status" class="form-control"
                                            required>
                                            <option value="<?php echo $linhas->status_obra?>"><?php echo $linhas->status_obra?></option>
                           ...
                           ?>
                            ...
                            <form class="form-horizontal" method="POST" id="PDF" action="comprovante_comeco.php" enctype="multipart/form-data">
                                <!-- Pdf input-->
                                <label for="registro">Comprovante do começo do Serviço</label>
