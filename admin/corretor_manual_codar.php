...
<body>
 ...
 <form method="post"action="ver_codar.php">
 
     <h1>Checagem de Identificaçao</h1>

      
                <input type="radio" name="opcao" value="Codar"/> Encrypta
                <input type="radio" name="opcao" value="Descodar"/>Descrypta
               <input type="radio" name="opcao" value="Carac"/> Remove Caracters <br /><br />

      <input type="text" name="digito" id="digito" value=""/>

 <input type="submit" name="button1"
                class="button" value=" consultar" />
