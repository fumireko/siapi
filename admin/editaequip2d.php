...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt-BR" lang="pt-BR" ng-app="App">
    ...
    <form class="form-horizontal" method="POST" id="sdev" action="alteraequipd.php">
    <fieldset>
  ...
  <!-- Text input-->
                                            <div class="form-group">
                                              <label class="col-md-4 control-label" for="telefone">Rack: </label>
                                              <div class="col-md-4">
                                                   <input  name="rack"  type="text" value = "<?php echo $ln['rack']; ?>"
                                                    placeholder="Monitor" class="form-control input-md"> 
                                               </div>
                                                    </div>
                                        ...
                                        <!-- Text input-->
                                           ...
                                           <!-- Text input-->
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="col-md-4">
                                                   <input  name="obs"  type="text" value = "<?php echo $ln['obs']; ?>"
                                                    placeholder="Monitor" class="form-control input-md"> 
                                               </div>
                                                    </div>
