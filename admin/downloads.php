        ...
        <header class="panel_header">
           <h2 class="title pull-left">Documentos</h2>
            ...
            switch ($nivel_usuario){
                ...
                break;
                case 1:
                    echo "<a href='uploadDocumento.php' class='btn btn-primary'>Adicionar Documentos</a>
                         <a href='removerDocumento.php?id_arquivo=$id_arquivo' class='btn btn-primary'>Remover Documentos</a></br></br>";
                break;
                default:
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="img-with-text">
                                    <a href="./upload/Documentos_para_download/<?php echo $linha['arquivo'];?>" target="_blank"><img id="foo" src="./upload/Documentos_para_download/<?php echo $linha['arquivo'];?>" width="150" height="100" alt="Icone" onerror="this.src='./upload/comeco_obras/icon.png';"></a>
