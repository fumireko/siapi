...
<body>
    ...
    <div class="col-lg-12">
        ...
        <header class="panel_header">
           <h2 class="title pull-left">SEMED</h2>
            </header>
            <div class="content-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
        
                            <form class="form-horizontal" method="POST" id="PDF" action="sconselho.php" enctype="multipart/form-data">
                                 <!-- SEMED-->
                                    <!-- Pdf input-->
                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="arquivo">Conselho Escolar Documento</label>
                                        <input id="tipo_documento" name="tipo_documento" type="text" value="13" hidden>
                                        <div class="col-md-4">
