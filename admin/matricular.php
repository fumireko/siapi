                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">    
                        ...
                        <div class="row">
                                ...
                                <td>
                                    ...
                                    <select name="motivo" required >
					                    ...
					                    <option value="Inclusao">Inclusao</option>
          			                    <option value="Rede">Rede de proteção</option>
                                        <option value="Transferencia">Outros</option>
           			                </select>
                                    </td>
                            ...
                            RESUMO FILA DE ESPERA CMEI <?PHP echo $tbcmei_nome; echo $unidade_usuario;?> 
                        </p>
                              ...
                              function tableCount($linha, $coluna) {
                                  ...
                                  $motivo = array("Normal", "Inclusão", "Conselho tutelar", "Rede de proteção", "Transferencia");
