           ...
           case '0': 
              ...
              ?>
                   <!--     <select name="sec_id" required>    -->
                        ...
                        $sql = "SELECT * from tb_controle_ti where status=1 and tab_origem=1 order by ctrl_ti desc ";
            ...
            case '1': 
             ...
             ?>
               ...
               <form method="post" enctype="multipart/form-data" action="salvaequip2.php">    
                                    ...
                                    <div class="container">
                                              <h2>Visualizaçao Completa   </h2>   
                                                     <?php echo "<center> <strong>   Dispositivo com 1 Monitores   </strong> </center> "; ?>   
                                                          <ul class="nav nav-tabs">
                                                             <li><a data-toggle="tab" href="#menu1">Pcs e afins</a></li>
                                                             <li class="active"><a data-toggle="tab" href="#home">Resumo </a></li>
                                                           </ul>
                                                        ...
                                                        <div id="menu1" class="tab-pane fade">
                                                           <center> <h3>Desktop(s) e Notebooks </h3> </center>
                                                            ...
                                                            $ln_ini = mysqli_fetch_assoc($dados);
                                                                ...
                                                                do {
                                                                            //$ln_ini = mysqli_fetch_assoc($dados);
                                                                            $codequip = $ln_ini['id_equip'];
                                                                            $ret_ctrl_ti = ret_cti_tbequip($conn, $codequip);
                                                                           $tipo_disp =  tipodoDispByCTI($conn, $ret_ctrl_ti) ;
                                                                            $img_nome = insere_icone($tipo_disp);
                                                                            echo "&nbsp &nbsp  <a href=ret_dados.php?id=" . $ret_ctrl_ti . "  >  <img src='img/".$img_nome."' title='".$tipo." ' height='30' width='30' >  &nbsp CTI &nbsp" . $ret_ctrl_ti . " </a> ";
                                                                            echo "<br />";
                                                                        } while ($ln_ini = mysqli_fetch_assoc($dados));
                                                                    }
                                                                                            ?> 
                                              ...
                                              <div id="home" class="tab-pane fade in active">
                                                      <?php echo "<center> <strong> Dados Resumidos para checagem  </strong> </center> <br> "; ?>   
                                                       <?php echo "<center> <strong> Computadores " . $total . "</strong> </center> <br> "; ?>   
                                             </div>
                                            </div>
                                        </div>
                                </form>                    
                                                            ...
                                                            $ln_ini = mysqli_fetch_assoc($dados);
                                                                    ...
                                                                    if ($total == 0) {
                                                                        ...
                                                                        do {
                                                                            ...
                                                                            $codequip = $ln_ini['id_equip'];
                                                                            $ret_ctrl_ti = ret_cti_tbequip($conn, $codequip);
                                                                            echo "&nbsp &nbsp  <a href=ret_dados.php?id=" . $ret_ctrl_ti . "  >  <img src='img/".$img_nome."' title=' ' height='30' width='30' >  &nbsp CTI &nbsp" . $ret_ctrl_ti . " </a> ";
                                                                            echo "<br />";
                                                                        } while ($ln_ini = mysqli_fetch_assoc($dados));
                                                                    }
                                                                                            ?> 
            ...
            case '4': { // recebe tipo mon_1a 
                ...
                <!--     <select name="sec_id" required>    -->
                                  <form method="post" enctype="multipart/form-data" action="salvaequip2.php">    
                                    ...
                                    <div class="container">
                                              <h2>Visualizaçao Completa   </h2>   
                                                     <?php echo "<center> <strong>   Dispositivo com 1 Monitor checagem   </strong> </center> "; ?>   
                                                          <ul class="nav nav-tabs">
                                                             <li><a data-toggle="tab" href="#menu1">Pcs e afins</a></li>
                                                             <li class="active"><a data-toggle="tab" href="#home">Resumo </a></li>
                                                           </ul>
                                                                ...
                                                                } else
                                                                {
                                                                    do
                                                                    {
                                                                        ...
                                                                        if (($ret_tabela == "1") or ($ret_tabela == 1)) {
                                                                            ...
                                                                            if ($totalm == 1) {
                                                                                do {
                                                                                    $codequip = $linham['id_equip'];
                                                                                    $ret_ctrl_ti_M = $linham['ctrl_ti'];
                                                                                    $ret_ctrl_ti = ret_cti_tbequip($conn, $codequip);
                                                                                     $tipo_disp = tipo_DispByCTI($conn, $ctrl_ti);   //function tipodoDispByCTI($Fconexao, $Fref) 
                                                                                     $img_nome = insere_icone($tipo_disp);
                                                                                 echo "&nbsp &nbsp  <a href=ret_dados.php?id=" . $ret_ctrl_ti . "  >  <img src='img/" . $img_nome . "' title='" . $tipo_disp . " ' height='30' width='30' >  &nbsp CTI &nbsp" . $ret_ctrl_ti . " </a>   - - >  <img src='img/tp2.png'  title=' ' height='30' width='30' >  &nbsp CTI &nbsp " . $ret_ctrl_ti_M;
                                                                                echo "<br />";
                                              ...
                                              <div id="home" class="tab-pane fade in active">
                                                      <?php echo "<center> <strong> Dados Resumidos para checagem  </strong> </center> <br> "; ?>   
                                                       <?php echo "<center> <strong> Computadores " . $cont . "</strong> </center> <br> "; ?>   
                                             </div>
                                            </div>
                                        </div>
                                </form>                    
             ...
             { // mon_2a  checagem
                ...
                <!--     <select name="sec_id" required>    -->
                               <form method="post" enctype="multipart/form-data" action="salvaequip2.php">    
                                    ...
                                    <div class="container">
                                              <h2>Visualizaçao Completa   </h2>   
                                                     <?php echo "<center> <strong>   Dispositivo com 2 Monitores checagem   </strong> </center> "; ?>   
                                                          <ul class="nav nav-tabs">
                                                             <li><a data-toggle="tab" href="#menu1">Pcs e afins</a></li>
                                                             <li class="active"><a data-toggle="tab" href="#home">Resumo </a></li>
                                                           </ul>
                                               <div class="tab-content">
                                                        <div id="menu1" class="tab-pane fade">
                                                           <center> <h3>Desktop(s) e Notebooks </h3> </center>
                                                            ...
                                                            $i = 0;
                                                            $cont = 0;
                                                            $sql = "SELECT * from tb_controle_ti where tab_origem=1 and status=1 order by ctrl_ti desc";
                                                            //   $sql = "SELECT * from tbequip where status=1";
                                                            $dados = mysqli_query($conn, $sql) or die(mysqli_error());
                                                            $ln_ini = mysqli_fetch_assoc($dados);
                                                            //$linha = mysqli_fetch_assoc($dados);
                                                            ...
                                                            if ($total == 0) {
                                                                ...
                                                                do {
                                                                    ...
                                                                    if (($ret_tabela == "1") or ($ret_tabela == 1)) {
                                                                        ...
                                                                        if ($totalm > 1) {
                                                                            $cont = $cont + 1;
                                                                            echo " <br>&nbsp &nbsp  <a href=ret_dados.php?id=" . $ctrl_ti . "  >  <img src='img/" . $img_nome . "' title=' ' height='30' width='30' >  &nbsp CTI &nbsp" . $ctrl_ti . " </a> &nbsp &nbsp  ";
                                                                            do {
                                                                                $codequip = $linham['id_equip'];
                                                                                $ret_ctrl_ti_M = $linham['ctrl_ti'];
                                                                                $ret_ctrl_ti = ret_cti_tbequip($conn, $codequip);
                                                                                echo "  <img src='img/tp2.png'  title=' ' height='30' width='30' >  &nbsp CTI &nbsp ".$ret_ctrl_ti_M." &nbsp " ;
                                                                                echo "  ";
