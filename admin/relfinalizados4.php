...
<body >
    ...
    <div class="clearfix"></div>
        ...
        <header class="panel_header">
                <h2 class="title pull-left">Chamados 2025 REG. OSASCO</h2>
         <h5 class="title pull-left"> <a id="gerarExcel" href="relfinalizados4.php" class="btn btn-primary">Dados sem  Borda</a></h5>        
       </header>
...
<body >
    ...
    <div class="clearfix"></div>
        ...
        <header class="panel_header">
                <h2 class="title pull-left">Chamados 2025 REG. OSASCO</h2>
          <h5 class="title pull-left"> <a id="gerarExcel" href="relfinalizados4.php?tipo=1" class="btn btn-primary">Dados com Borda</a></h5>       
       </header>
         <!-- Dados do atendimento-->
