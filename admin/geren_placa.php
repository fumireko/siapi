...
if (($ret_id == 0) or ($ret_id == "")) 
  ...
  {
    $sql1 = "SELECT * FROM tb_placa where p_id ='" . $ret_id . "' ";
...
<html>
    <head>
    <title>Gerenciamento de Placas</title>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            ...
                            <form method="post" action="direciona3.php">    
                              <input type="hidden" name="placa_id"  value= "<?php echo $ret_id ?>">  
                             ...
                             <label>Selecione a Ação a ser executada :  
                                  ...
                                  <select name="acao" >
                                                        ...
                                                        <option value="1" default>Alteraçao</option>
                                                        <option value="2">Exclusão</option>                  
                                                        
                                                    </select>
                                 </div>  
                           
                                            <label >Descrição da Placa Mãe</label><br />
