...
<?php
  ...
  $sql = "SELECT * FROM solicitacao_servicos WHERE categoria = 'Obra' ORDER BY id_solicitacao";
...
<?php
                                ...
                                ?>
                                        <tr>
                                            <td><a class="btn btn-primary" href="obras_inf.php?id_solicitacao=<?php echo $ln['id_solicitacao']?>"><?php echo $ln['id_pedido'];?>/<?php echo $ln['ano_pedido'];?></a></td>
                                            ...
                                            <td><a href="fim_obra.php?id_solicitacao=<?php echo $ln['id_solicitacao']?>">Finalizar</a></td>
                                        </tr>
                                <?php
                                }    
                                ?>    
