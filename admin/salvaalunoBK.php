...
if ($nome !=""){
    $result = mysql_query('SELECT * FROM tbaluno where tbaluno_cpf = "'.$cpf.'" ');
	if ($result){
		 while ($row = mysql_fetch_assoc($result)) {
		 echo "<font color=red><b>  ".'JA EXISTE UM CADASTRO DO CPF :' .$row['tbaluno_cpf'].' <br>';
...
$data_inf1 = '2018-04-01';
$data_inf2 = '2017-04-01';
$data_inf3 = '2016-04-01';
$data_inf4 = '2015-04-01';
$data_inf5 = '2014-04-01';

if(strtotime($dta_nasc) >= strtotime($data_inf1))
{
 $sqlinsert  = "INSERT INTO  semed.tbaluno(tbaluno_nome, 
 tbaluno_dtnasc,
 tbaluno_turma,
 tbaluno_nmae,
 tbaluno_cpf,	
...
{
$sqlinsert  = "INSERT INTO  semed.tbaluno(tbaluno_nome, tbaluno_dtnasc,tbaluno_turma,tbaluno_nmae,tbaluno_cpf,	
...
VALUES('$nome','$dta_nasc','INF2','$nome_mae','$cpf','$telefone','$celu','$cep','$rua','$num','$comp','$bairro','$cidade','Pendente',now(),'$nome_usuario','$celular');";
mysql_query($sqlinsert) or die("Não foi possivel inserir os dados INF 2"); //Ou vai..., ou racha.
...
elseif(strtotime($dta_nasc) >= strtotime($data_inf3))
{
	$sqlinsert  = "INSERT INTO  semed.tbaluno(tbaluno_nome, tbaluno_dtnasc,tbaluno_turma,tbaluno_nmae,tbaluno_cpf,	
	tbaluno_tel,celu,tbaluno_cep,tbaluno_end,tbaluno_num,tbaluno_comple,tbaluno_bairro,tbaluno_cidade,tbaluno_status,tbaluno_datacad,tbaluno_login,celu2)
	VALUES('$nome','$dta_nasc','INF3','$nome_mae','$cpf','$telefone','$celu','$cep','$rua','$num','$comp','$bairro','$cidade','Pendente',now(),'$nome_usuario','$celular');";
	mysql_query($sqlinsert) or die("Não foi possivel inserir os dados INF 3"); //Ou vai..., ou racha.
...
$sqlinsert  = "INSERT INTO semed.tbaluno(tbaluno_nome, tbaluno_dtnasc,tbaluno_turma,tbaluno_nmae,tbaluno_cpf,	
tbaluno_tel,celu,tbaluno_cep,tbaluno_end,tbaluno_num,tbaluno_comple,tbaluno_bairro,tbaluno_cidade,tbaluno_status,tbaluno_datacad,tbaluno_login,celu2)
VALUES('$nome','$dta_nasc','INF4','$nome_mae','$cpf','$telefone','$celu','$cep','$rua','$num','$comp','$bairro','$cidade','Pendente',now(),'$nome_usuario','$celular');";
...
$sqlinsert  = "INSERT INTO semed.tbaluno(tbaluno_nome, tbaluno_dtnasc,tbaluno_turma,tbaluno_nmae,tbaluno_cpf,	
tbaluno_tel,celu,tbaluno_cep,tbaluno_end,tbaluno_num,tbaluno_comple,tbaluno_bairro,tbaluno_cidade,tbaluno_status,tbaluno_datacad,tbaluno_login,celu2)
VALUES('$nome','$dta_nasc','INF5','$nome_mae','$cpf','$telefone','$celu','$cep','$rua','$num','$comp','$bairro','$cidade','Pendente',now(),'$nome_usuario','$celular');";
...
$sqlinsert  = "INSERT INTO  semed.tbaluno(tbaluno_nome, tbaluno_dtnasc,tbaluno_turma,tbaluno_nmae,tbaluno_cpf,	
tbaluno_tel,celu,tbaluno_cep,tbaluno_end,tbaluno_num,tbaluno_comple,tbaluno_bairro,tbaluno_cidade,tbaluno_status,tbaluno_datacad,tbaluno_login,celu2)
VALUES('$nome','$dta_nasc','FNDAMENTAL','$nome_mae','$cpf','$telefone','$celu','$cep','$rua','$num','$comp','$bairro','$cidade','Pendente',now(),'$nome_usuario','$celular');";
