                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">    
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                            <div class="form-group  col-md-6">
                            <form class="form-horizontal" method="POST" id="busca_inc" action = "result_listatransf.php">
                            <?php 
                            ...
                            <table>
                                ...
                                <tr>
                                <td>
                                    <select name="id_cmei" id="id_cmei" style="width:200px;"required>
                                    <?php
                                        if ($nivel == 1){
                                        ...
                                        {
                                            echo "<option value=$unidade_usuario>$tbcmei_nome</option>";
                                        }
                            ...
                            <table class="table table-hover table-bordered display">
                              ...
                              <tbody>
                                 <tr>
                                    ...
                                    <td align="center"><a href='lista_inf1n.php?motivo=Transferencia&turma=INF1'><?php tranCount($linha); $coluna = 0; $linha++;?></a></td>
                                 </tr>
                                 <tr>
                                    <td align="center"><i class="fa fa-star" aria-hidden="true"></i>  Infantil 2</td>
                                    
                                    <td align="center"><a href='lista_inf1n.php?motivo=Transferencia&turma=INF2'><?php tranCount($linha); $coluna = 0; $linha++;?></a></td>
                                 </tr>
                                 <tr>
                                    <td align="center"><i class="fa fa-rocket" aria-hidden="true"></i>  Infantil 3</td>
                                    
                                    <td align="center"><a href='lista_inf1n.php?motivo=Transferencia&turma=INF3'><?php tranCount($linha); $coluna = 0; $linha++;?></a></td>
                                 </tr>
                                 <tr>
                                    <td align="center"><i class="fa fa-futbol-o" aria-hidden="true"></i>  Infantil 4</td>
                                    
                                    <td align="center"><a href='lista_inf1n.php?motivo=Transferencia&turma=INF4'><?php tranCount($linha); $coluna = 0; $linha++;?></a></td>
                                 </tr>
                              </tbody>
                           </table>
                           </form>
