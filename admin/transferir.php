    ...
    <div class="col-lg-12">
        <section class="box ">
            <header class="panel_header">
                <h2 class="title pull-left">Transferir</h2>
            </header>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">    
                        ...
                        <div class="row">
                            <div class="form-group  col-md-6">
                                <a id="gerarExcel" href="matriculados_gerarExcel.php" class="btn btn-primary">Gerar Relatório</a>                         
                            </div>
                            <div class="row">
                            <div class="form-group  col-md-6">
                            <form class="form-horizontal" method="POST" id="busca_inc" action = "busca_transf.php">
                            <?php 
                            ...
                            RESUMO DE ALUNOS MATRICULADOS NO CMEI <?PHP echo $tbcmei_nome;?> 
                        </p>
                              ...
                              function tableCount($linha, $coluna) {
                                  ...
                                  and tbfila_status ='matriculado'  ") or die('Erro, query falhou');
