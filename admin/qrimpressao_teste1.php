                                  ...
                                  <div id="div1">
                                      ...
                                      <tr>
                                       <td>  <table border="0">
                                             ...
                                             <tr><td> <?php echo "<center> <label style=color:black> <b> ID = " . $ret_id . "   </b>  </label></center> "; ?> </td></tr>
                                          
                                          </table>  </td> 
                                          <td>   <?php echo "<img  src='{$qrCodeName}'width='172px'height='98px'>"; ?> </td>
